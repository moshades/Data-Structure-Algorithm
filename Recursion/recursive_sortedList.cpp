...
int main() {
   ...
   attendeesList.push_back("Messi, Lionel");
   attendeesList.push_back("Ronaldo, Cristiano");
   attendeesList.push_back("Haaland, Erling");
   attendeesList.push_back("Roberto, Carlos");
   attendeesList.push_back("Mancini, Roberto");
